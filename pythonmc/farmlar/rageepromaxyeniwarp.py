...
for i in range(999):
    ...
    craftCount = 0
    print("tur"+str(i))
    pyautogui.write("t  /is w ragee   ", interval=sleepVal)
    pyautogui.press("enter")
    ...
    pyautogui.moveRel(0,-100,duration= sleepVal)
    if (i % 2) == 0 :
        pyautogui.moveRel(-400,0,duration= sleepVal)
        pyautogui.moveRel(-400,0,duration= sleepVal)
        
    else:
        pyautogui.moveRel(470,0,duration= sleepVal)
        pyautogui.moveRel(470,0,duration= sleepVal)


    pyautogui.keyDown("ctrl")
    pyautogui.keyDown("w")
    time.sleep(5)  # i 0 a bölnüyorsa sola git
    pyautogui.keyUp("w")
    pyautogui.keyUp("ctrl")
    
    if (i % 2) == 0 :
        pyautogui.moveRel(100,0,duration= sleepVal) # sol
        pyautogui.moveRel(100,0,duration= sleepVal)
        keyboard.press("shift")
        pyautogui.keyDown("s")
        time.sleep(0.3)
        pyautogui.keyUp("s")
        ...
        pyautogui.moveRel(0,330,duration= sleepVal)
        ...
        pyautogui.moveRel(-170,0,duration= sleepVal)
        pyautogui.keyDown("a")
        time.sleep(2.2)  # i 0 a bölnüyorsa sola git
        pyautogui.keyUp("a")
        
        pyautogui.moveRel(0,110,duration= sleepVal)
