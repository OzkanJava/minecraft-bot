...
for i in range(9999):
    ...
    pyautogui.write("t  /is w pigmanalona   ", interval=sleepVal)
    pyautogui.press("enter")
    ...
    pyautogui.moveRel(0,-100,duration= sleepVal)
    if (i % 2) == 0 :
        pyautogui.moveRel(-220,0,duration= sleepVal) # sol
        pyautogui.moveRel(-220,0,duration= sleepVal)
    ...
    if (i % 2) == 0 :
        pyautogui.moveRel(-80,0,duration= sleepVal) # sol
        pyautogui.moveRel(-80,0,duration= sleepVal)
