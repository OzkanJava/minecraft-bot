...
def lookUp(i):
    ...
    pyautogui.moveRel(0,80*-1*i,duration=0.04)
    pyautogui.moveRel(0,80*-1*i,duration=0.04)
    """
...
def checkWarp():
    ...
    return pixel1 == (126,102,63) or pixel2 == (126,102,63)
...
for i in range(1,999):
    ...
    craftCount = 0
    print("tur"+str(i))
    pyautogui.write("t /is w pigsus   ", interval=sleepVal)
    pyautogui.press("enter")
    ...
    pyautogui.moveRel(0,-100,duration= sleepVal)
    if( i%2 == 0):
        pyautogui.moveRel(-300,0,duration= sleepVal)
        pyautogui.moveRel(-300,0,duration= sleepVal)
    else:
        pyautogui.moveRel(300,0,duration= sleepVal)
        pyautogui.moveRel(300,0,duration= sleepVal)
    ...
    time.sleep(0.5)
    pyautogui.keyUp("space")# i 0 a bölnüyorsa sola git
    pyautogui.keyUp("w")
    ...
    if( i%2 == 0):
        pyautogui.moveRel(2,0,duration= sleepVal)
    ...
    pyautogui.moveRel(0,340,duration= sleepVal)
    time.sleep(0.03)
