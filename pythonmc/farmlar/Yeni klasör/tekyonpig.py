...
def fixgoldblock(ilkdeger,sondeger):
    ...
    for i in range(ilkdeger, sondeger):
        mouse.move(fixX, fixY - (sabit) * space, duration=durationVal)
        mouse.click()
        mouse.move(fixX - i * space, fixY, duration=durationVal)
        mouse.click()
        sabit+=1
...
def fixironblock(ilkdeger, sondeger):
    ...
    for i in range(ilkdeger, sondeger):
        mouse.move(fixX - i * space, fixY, duration=durationVal)
        mouse.click()
        mouse.move(fixX, fixY - ((i % 3) + 1) * space, duration=durationVal)
        mouse.click()
        mouse.move(fixX - i * space, fixY, duration=durationVal)
        mouse.click()
...
for i in range(1,1000):
    ...
    pyautogui.write("t       /is w pokerrfac    ", interval=sleepVal)
    pyautogui.press("enter")
    ...
    time.sleep(2.5)# i 0 a bölnüyorsa sola git
    pyautogui.keyUp("w")
